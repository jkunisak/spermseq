...
some_moderate_genes <- c("DMRT1", "M1AP", "SYCP2", "TEX14", "USP26")
moderate_genes <- moderate_genes[-which(moderate_genes %in% some_moderate_genes)]
moderate_gene_ids <- moderate_gene_ids[-which(moderate_gene_ids %in% some_moderate_genes)]
...
if (file.exists("~/git/spermseq/script/final_some_moderate_genes.Rdata")) {
  load("~/git/spermseq/script/final_some_moderate_genes.Rdata")
}
...
```{r}
if (file.exists("~/git/spermseq/script/final_some_moderate_genes.Rdata") == FALSE) {
...
if (file.exists("~/git/spermseq/script/final_some_moderate_genes.Rdata") == FALSE) {
  ...
  if (file.exists("~/git/spermseq/script/gtf_df_some_moderate_genes.Rdata")) {
    load("~/git/spermseq/script/gtf_df_some_moderate_genes.Rdata")
  }
  ...
  if (!file.exists("~/git/spermseq/script/gtf_df_some_moderate_genes.Rdata")) {
    ...
    gtf_df
    save.image("~/git/spermseq/script/gtf_df_some_moderate_genes.Rdata")
...
if (file.exists("~/git/spermseq/script/final_some_moderate_genes.Rdata") == FALSE) {
  ...
  if (file.exists("~/git/spermseq/script/pfam_df_some_moderate_genes.Rdata")) {
    load("~/git/spermseq/script/pfam_df_some_moderate_genes.Rdata")
  }
  ...
  if (!file.exists("~/git/spermseq/script/pfam_df_some_moderate_genes.Rdata")) {
    ...
    ## Save image
    save.image("~/git/spermseq/script/pfam_df_some_moderate_genes.Rdata")
...
if (file.exists("~/git/spermseq/script/final_some_moderate_genes.Rdata") == FALSE) {
  ...
  ## Save the data
  save.image("~/git/spermseq/script/final_some_moderate_genes.Rdata")
}

if (file.exists("~/git/spermseq/script/final_some_moderate_genes.Rdata") == TRUE) {
  load("~/git/spermseq/script/final_some_moderate_genes.Rdata")
}
```
